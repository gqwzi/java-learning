...
## [原文](https://www.cnblogs.com/Alandre/p/4456719.html)

# 认识&理解关键字 native 实战篇

初次遇见 native 是在 java.lang.Object 源码中的一个hashCode方法：
```java
...
![](../images/basic/navicat_2.png)

就得到了下面的 HelloNative.h文件 ：
> 在MAC jdk11 执行 javah HelloNative 提示找不到这个类文件
```c
